...
public class CoinDistribution {
    ...
    public static void main(String[] args) {
        ...
        coinDistribution.printTree(coinDistribution.rootNode);
    }
    ...
    private void printTree(CoinNode coinNode) {
        System.out.println(coinNode);
        List<CoinNode> coinNodes = new ArrayList<>();
        for (CoinNode node : coinNode.getCoinNodes()) {
            System.out.print(node + " ");
            coinNodes.addAll(node.getCoinNodes());
        }
        System.out.println();
        for (CoinNode node : coinNodes) {
            printTree(node);
        }
